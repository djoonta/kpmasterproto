...
all: verification_status_reject bank encumbrance installment occupation main

.PHONY: verification_status_reject bank encumbrance installment occupation main all
